<?php
function custom_second_gallery_shortcode()
{
    $post_id = get_the_ID();
    $background_image = get_post_meta($post_id, 'second_gallery_background', true);
    $title = get_post_meta($post_id, 'second_gallery_title', true);
    $description = get_post_meta($post_id, 'second_gallery_description', true);
    $gallery_images = get_post_meta($post_id, 'second_gallery_images', true);
    ...
    <li>
        <div class="w-full min-h-screen min-h-[700px] flex flex-col bg-cover bg-center relative overflow-hidden">
            ...
            <div class="nav_gap flex-grow flex items-center relative z-10">
                <div class="container mx-auto px-4" data-page-no="3" data-page-type="gallery">
                            ...
                            <?php foreach ($gallery_images as $img): ?>
                                ...
                                <div class="overflow-hidden rounded shadow-lg group relative">
                                    ...
                                    <div
                                        ...
                                        <div class="border border-white rounded-lg p-8 text-white text-center max-w-xs">
...
add_shortcode('second_gallery', 'custom_second_gallery_shortcode');
?>